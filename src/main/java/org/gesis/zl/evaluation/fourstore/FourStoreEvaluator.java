 ...
 * 
 */
public class FourStoreEvaluator
{
	...
	private void execute() throws InterruptedException
	{
		...
		{
			Callable<Long> queryExecution = new FourStoreQueryExecutor( properties.getServerUrl() + properties.getServerDbName(), queriesToExecute[i] );
