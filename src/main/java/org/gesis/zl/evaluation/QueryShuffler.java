...
public class QueryShuffler
{
	...
	public static String[][] readAndShuffle( final String fromFolder, final int multiplyNumberOfQueries )
	{
		...
		String[][] queries = mapQueryNameToQuery( filenamesList );
	 ...
	 * @return
	 */
	private static String[][] mapQueryNameToQuery( File[] filenamesList )
	{
	 ...
	 * @return
	 */
	public static File[] getQueries( final String fromFolder, final String... availableQueries )
	{
