...
for tps in ["1"]:
  ...
  os.system( "sudo -u matthaeus -H JRE_HOME=\"/usr/lib/java/jdk1.7.0_75\" JAVA_OPTS=\"-Xmx6G\" /home/matthaeus/Projects/apache-tomcat-6.0.43/bin/startup.sh" );
  time.sleep(10);
  ...
  print "wait until sesame can breath again..";
  time.sleep(10);
